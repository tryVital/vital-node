...
export interface GetOrdersLabTestsRequest {
     ...
     */
    status?: Vital.OrderLowLevelStatus[];
    /**
     * Order key to sort by.
     */
    orderKey?: Vital.GetOrdersLabTestsRequestOrderKey;
    /**
     * Order direction to sort by.
     */
    orderDirection?: Vital.GetOrdersLabTestsRequestOrderDirection;
    /**
     * Filter by method used to perform the lab test.
     */
    orderType?: Vital.LabTestCollectionMethod[];
    /**
     ...
     */
    orderActivationTypes?: Vital.OrderActivationType[];
    /**
     * Filter by user ID.
     */
    userId?: string;
