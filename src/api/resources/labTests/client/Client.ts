...
export class LabTests {
    ...
    public async getMarkersForLabTest(
        labTestId: string,
        requestOptions?: LabTests.RequestOptions
    ): Promise<Vital.ClientFacingMarkerComplete[]> {
        const _response = await core.fetcher({
            url: urlJoin(
                (await core.Supplier.get(this._options.environment)) ?? environments.VitalEnvironment.Production,
        ...
        if (_response.ok) {
            return await serializers.labTests.getMarkersForLabTest.Response.parseOrThrow(_response.body, {
                unrecognizedObjectKeys: "passthrough",
                allowUnrecognizedUnionMembers: true,
                allowUnrecognizedEnumValues: true,
                breadcrumbsPrefix: ["response"],
     ...
     * @throws {@link Vital.UnprocessableEntityError}
     */
    public async getResultPdf(orderId: string, requestOptions?: LabTests.RequestOptions): Promise<unknown> {
        const _response = await core.fetcher({
            url: urlJoin(
                (await core.Supplier.get(this._options.environment)) ?? environments.VitalEnvironment.Production,
     ...
     * @throws {@link Vital.UnprocessableEntityError}
     */
    public async getOrderRequistionPdf(orderId: string, requestOptions?: LabTests.RequestOptions): Promise<unknown> {
        const _response = await core.fetcher({
            url: urlJoin(
                (await core.Supplier.get(this._options.environment)) ?? environments.VitalEnvironment.Production,
