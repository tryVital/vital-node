...
describe("UserClient", () => {
            ...
            users: [
                {
                    ...
                    created_on: "2026-01-21T13:43:16Z",
                    connected_sources: [
                        {
                    ...
                    fallback_time_zone: {
                        id: "Europe/London",
                        source_slug: "manual",
                        updated_at: "2026-01-21T13:43:16Z",
                    },
                    fallback_birth_date: {
                        value: "1989-09-12",
                        source_slug: "manual",
            ...
            users: [
                {
                    ...
                    createdOn: new Date("2026-01-21T13:43:16.000Z"),
                    connectedSources: [
                        {
                            provider: {
                                name: "Oura",
                    ...
                    fallbackTimeZone: {
                        id: "Europe/London",
                        sourceSlug: "manual",
                        updatedAt: new Date("2026-01-21T13:43:16.000Z"),
                    },
                    fallbackBirthDate: {
                        value: "1989-09-12",
                        sourceSlug: "manual",
    ...
    test("get_by_client_user_id (1)", async () => {
        ...
        const rawResponseBody = {
            ...
            fallback_time_zone: { id: "Europe/London", source_slug: "manual", updated_at: "2026-01-21T13:43:16Z" },
            fallback_birth_date: { value: "1989-09-12", source_slug: "manual", updated_at: "2026-01-21T13:43:16Z" },
            ingestion_start: "ingestion_start",
            ingestion_end: "ingestion_end",
        };
        server
