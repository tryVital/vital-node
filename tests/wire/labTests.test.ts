...
describe("LabTestsClient", () => {
    ...
    test("get_orders (1)", async () => {
        ...
        const rawResponseBody = {
            orders: [
                {
                    user_id: "23c9b865-1027-46da-890e-407961b53f35",
                    id: "7a0011b3-cede-4840-bac4-a29fbe018979",
                    team_id: "8d2b8062-c8ee-4f78-81ab-eab8de15deb8",
                    ...
                    details: {
                        type: "testkit",
                        data: {
                            id: "43789771-822a-452e-8d48-2b559cb62981",
                            shipment: {
                                id: "43940f49-7ec2-44ff-9405-c84e5f820fba",
        ...
        expect(response).toEqual({
            orders: [
                {
                    userId: "23c9b865-1027-46da-890e-407961b53f35",
                    id: "7a0011b3-cede-4840-bac4-a29fbe018979",
                    teamId: "8d2b8062-c8ee-4f78-81ab-eab8de15deb8",
                    patientDetails: {
    ...
    test("book_phlebotomy_appointment (1)", async () => {
        ...
        const rawResponseBody = {
            id: "0c7f25a8-ccf5-4272-bc25-71b7aa238794",
            user_id: "90ccba7a-578c-467c-807a-824acf5779ce",
            order_id: "839e0b59-f6ab-4228-bf13-25c98a2f2a04",
            address: {
                first_line: "123 Main St.",
                second_line: "Apt. 208",
                city: "San Francisco",
        ...
        expect(response).toEqual({
            id: "0c7f25a8-ccf5-4272-bc25-71b7aa238794",
            userId: "90ccba7a-578c-467c-807a-824acf5779ce",
            orderId: "839e0b59-f6ab-4228-bf13-25c98a2f2a04",
            address: {
                firstLine: "123 Main St.",
                secondLine: "Apt. 208",
                city: "San Francisco",
    ...
    test("request_phlebotomy_appointment (1)", async () => {
        ...
        const rawResponseBody = {
            id: "c0db7201-4e78-4a5f-bead-38386ec79696",
            user_id: "25e7fb49-6122-4ad8-badd-119e404b3679",
            order_id: "68a4d795-45f6-4716-82f9-535b6978a1bc",
            address: {
                first_line: "123 Main St.",
                second_line: "Apt. 208",
                city: "San Francisco",
        ...
        expect(response).toEqual({
            id: "c0db7201-4e78-4a5f-bead-38386ec79696",
            userId: "25e7fb49-6122-4ad8-badd-119e404b3679",
            orderId: "68a4d795-45f6-4716-82f9-535b6978a1bc",
            address: {
                firstLine: "123 Main St.",
                secondLine: "Apt. 208",
                city: "San Francisco",
    ...
    test("get_phlebotomy_appointment_cancellation_reason", async () => {
        ...
        const rawResponseBody = [
            { id: "fc2e8e81-473f-4ac4-986e-678cfe42ee21", name: "I'm feeling sick", is_refundable: true },
        ];
        server
            .mockEndpoint()
        ...
        expect(response).toEqual([
            {
                id: "fc2e8e81-473f-4ac4-986e-678cfe42ee21",
