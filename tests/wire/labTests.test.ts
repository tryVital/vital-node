...
describe("LabTestsClient", () => {
    ...
    test("book_phlebotomy_appointment (1)", async () => {
        ...
        const rawResponseBody = {
            id: "6e6a17d8-3aba-4071-b10c-5bcd844416af",
            user_id: "3cdb7afa-c9bc-4ba8-babf-bded9d448247",
            order_id: "68a4645c-0f6e-471b-9ee3-ad3a894b0d63",
            address: {
                first_line: "123 Main St.",
                second_line: "Apt. 208",
                city: "San Francisco",
        ...
        expect(response).toEqual({
            id: "6e6a17d8-3aba-4071-b10c-5bcd844416af",
            userId: "3cdb7afa-c9bc-4ba8-babf-bded9d448247",
            orderId: "68a4645c-0f6e-471b-9ee3-ad3a894b0d63",
            address: {
                firstLine: "123 Main St.",
                secondLine: "Apt. 208",
                city: "San Francisco",
    ...
    test("request_phlebotomy_appointment (1)", async () => {
        ...
        const rawResponseBody = {
            id: "e19191b3-505d-4efe-a18b-fe9e15511f8a",
            user_id: "6965f0e4-5eb6-429a-a985-8a35d2f97056",
            order_id: "233c387c-01fc-4bf0-8c72-c527cc34745f",
            address: {
                first_line: "123 Main St.",
                second_line: "Apt. 208",
                city: "San Francisco",
        ...
        expect(response).toEqual({
            id: "e19191b3-505d-4efe-a18b-fe9e15511f8a",
            userId: "6965f0e4-5eb6-429a-a985-8a35d2f97056",
            orderId: "233c387c-01fc-4bf0-8c72-c527cc34745f",
            address: {
                firstLine: "123 Main St.",
                secondLine: "Apt. 208",
                city: "San Francisco",
    ...
    test("get_phlebotomy_appointment_cancellation_reason", async () => {
        ...
        const rawResponseBody = [
            { id: "518eaf4d-65b3-4bd9-82ce-3b33c3f2ade8", name: "I'm feeling sick", is_refundable: true },
        ];
        server
            .mockEndpoint()
        ...
        expect(response).toEqual([
            {
                id: "518eaf4d-65b3-4bd9-82ce-3b33c3f2ade8",
