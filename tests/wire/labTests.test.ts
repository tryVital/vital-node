...
describe("LabTestsClient", () => {
    ...
    test("get_orders (1)", async () => {
        ...
        const rawResponseBody = {
            orders: [
                {
                    user_id: "893c2b73-bf64-4a64-80bc-b5e1785098be",
                    id: "01a83fc6-ba7c-43fe-8e59-d2d6ca2d331c",
                    team_id: "4e4bad5c-e1b4-4ac2-aae9-f730533fbdfc",
                    ...
                    details: {
                        type: "testkit",
                        data: {
                            id: "e08fae85-e63b-4c09-8132-621a4b76683b",
                            shipment: {
                                id: "b1bab53b-5979-4807-a176-f969e3cf47e1",
        ...
        expect(response).toEqual({
            orders: [
                {
                    userId: "893c2b73-bf64-4a64-80bc-b5e1785098be",
                    id: "01a83fc6-ba7c-43fe-8e59-d2d6ca2d331c",
                    teamId: "4e4bad5c-e1b4-4ac2-aae9-f730533fbdfc",
                    patientDetails: {
    ...
    test("book_phlebotomy_appointment (1)", async () => {
        ...
        const rawResponseBody = {
            id: "00af7bd3-6d28-4163-b19b-f36bdb927e9b",
            user_id: "0393cb4a-cd73-4a50-9545-14ccb47b7655",
            order_id: "8b808639-4874-437a-a591-bd0d637049a3",
            address: {
                first_line: "123 Main St.",
                second_line: "Apt. 208",
                city: "San Francisco",
        ...
        expect(response).toEqual({
            id: "00af7bd3-6d28-4163-b19b-f36bdb927e9b",
            userId: "0393cb4a-cd73-4a50-9545-14ccb47b7655",
            orderId: "8b808639-4874-437a-a591-bd0d637049a3",
            address: {
                firstLine: "123 Main St.",
                secondLine: "Apt. 208",
                city: "San Francisco",
    ...
    test("request_phlebotomy_appointment (1)", async () => {
        ...
        const rawResponseBody = {
            id: "f71aafd1-57d9-4bc3-982b-70a1b140d92c",
            user_id: "a52903f1-5625-4b1d-8f2b-9dd1149b6010",
            order_id: "f63e47cd-e793-457d-b6ca-2c9cc10a1db7",
            address: {
                first_line: "123 Main St.",
                second_line: "Apt. 208",
                city: "San Francisco",
        ...
        expect(response).toEqual({
            id: "f71aafd1-57d9-4bc3-982b-70a1b140d92c",
            userId: "a52903f1-5625-4b1d-8f2b-9dd1149b6010",
            orderId: "f63e47cd-e793-457d-b6ca-2c9cc10a1db7",
            address: {
                firstLine: "123 Main St.",
                secondLine: "Apt. 208",
                city: "San Francisco",
    ...
    test("get_phlebotomy_appointment_cancellation_reason", async () => {
        ...
        const rawResponseBody = [
            { id: "62e38f6b-fd44-45b9-be66-eeaf5e53e61a", name: "I'm feeling sick", is_refundable: true },
        ];
        server
            .mockEndpoint()
        ...
        expect(response).toEqual([
            {
                id: "62e38f6b-fd44-45b9-be66-eeaf5e53e61a",
